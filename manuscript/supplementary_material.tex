...
This release validation command checks the manifest schema, required artifact files, required result identifiers, checksum coverage, repository commit metadata, claim-boundary flags, and exclusion of raw third-party data, caches, credentials, local outputs, and model checkpoints.
