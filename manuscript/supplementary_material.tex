...
LLM pair-judge evidence is auxiliary unless executed with traceable logs. & API-backed execution summary, model name, prompt version, output file, and checksum. & Does not replace human annotation and should not be merged with human-gold labels. \\
\bottomrule
\end{tabular}
\end{table}
