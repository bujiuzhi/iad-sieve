...
\midrule
Required variants & no-risk-gate, no-ANI-head, single-space, no-cannot-link, and post-hoc-threshold outputs are all present. & Component causality from only one removed head or one threshold sweep. \\
...
Interpretation rule & Accepted variants may support component-causality statements within the released scope. & Variants with changed pair universe, threshold-selection source, or prediction schema remain exploratory diagnostics. \\
\bottomrule
\end{tabular}
\end{table}
