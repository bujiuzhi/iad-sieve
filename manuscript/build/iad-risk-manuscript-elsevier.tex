...
The baseline set is selected by evidence availability and evaluation relevance rather than by convenience. Table~\ref{tab:baseline-inclusion-rationale} states which baseline families are used as primary evidence and which are kept outside the main result table until their artifacts are complete. This prevents utility code, fixture-level checks, or partially audited runs from being presented as if they were complete comparison experiments.
