...
Any external artifact release should redistribute derived tables, predictions, logs, manifests, and checksums rather than raw provider files unless the original provider terms explicitly allow redistribution; \path{source_input_manifest} must record the original provider, acquisition date or version, local file boundary, license boundary, and checksum for each public input source.
