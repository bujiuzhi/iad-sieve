...
The public-source reconstruction chain is documented as \texttt{prepare-deepmatcher}, \texttt{prepare-scirepeval-proximity}, \texttt{fetch-openalex-works}, \texttt{prepare-openalex-weak-labels}, and \texttt{build-iad-bench}; these commands write schema-bound JSONL and summary outputs rather than raw-data copies.
