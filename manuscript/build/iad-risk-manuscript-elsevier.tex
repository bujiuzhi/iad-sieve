...
Derived evaluation artifacts & External artifact release. & Supports L2/L3 result-level audit through prediction files, threshold logs, manifests, checksums, and commit identifiers. \\
\bottomrule
\end{tabular}
\end{table}
