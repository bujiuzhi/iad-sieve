...
This gate checks whether the main result section could be read as dismissing the RoBERTa pair classifier or as claiming broad superiority from mixed row scopes. It cannot. The main result interpretation now states that RoBERTa pair classification is a strong baseline that can already suppress many unsafe merges under the full Open-v2 scope, while IAD-Risk should be read as an auditable relation-role design rather than a broad superiority claim.
