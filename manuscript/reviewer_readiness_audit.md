...
41. `final_upload_information_request.md` records both the Q2/B ranking cross-check and artifact publication cross-check; final-upload package validation is not run as a pass condition until those external evidence chains are complete.
